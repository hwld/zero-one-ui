...
const CustomRange = forwardRef<HTMLSpanElement, RadixSlider.SliderThumbProps>(function CustomRange(
  { style, ...others },
  ref,
) {
  const right = parseFloat(style?.right?.toString().split("calc(")[0] ?? "0") ?? 0;

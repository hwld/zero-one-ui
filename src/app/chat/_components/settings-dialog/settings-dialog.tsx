...
export const SettingsDialog = forwardRef<HTMLDivElement, Props>(function SettingsDialog(
  { onOpenChange, animate, initial },
  ref,
) {
  return (
...
const SettingGroup: React.FC<{ group: string; children: ReactNode }> = ({ group, children }) => {
  return (

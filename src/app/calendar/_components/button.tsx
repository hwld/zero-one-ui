...
const ButtonBase = forwardRef<HTMLButtonElement, ButtonBaseProps>(function ButtonBase(
...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(function Button(
  ...
  const variantClass = {
    default: "bg-neutral-100 border border-neutral-300 text-neutral-700 hover:bg-neutral-200",
  ...
  return (
    <ButtonBase
      ref={ref}
      {...props}
      className={cn(variantClass[variant], sizeClass[size], active && "bg-neutral-200")}
    >
      {children}
    </ButtonBase>
  );

...
export const EventInRowCardBase = forwardRef<HTMLButtonElement, Props>(function EventInRowCardBase(
  {
...
export const EventInRowCardContent: React.FC<ContentProps> = ({ eventInRow, isDragging }) => {
  return (
    <div
      className={clsx(

import { differenceInMinutes, eachHourOfInterval, endOfDay, isSameDay, startOfDay } from "date-fns";
  ...
  return (
    <div className="flex flex-col gap-2" ref={ref}>
      <div className="border-r border-neutral-200">
        <EventsColumn eventsInCol={displayedEventsInCol} displayedDay={displayedDay}>
          {hours.map((hour, i) => {
            if (i === 0) {
              return null;
            }

...
export const TaskDetailSheet = forwardRef<HTMLDivElement, Props>(function TaskDetailSheet(
  { taskId, isOpen, onOpenChange },
  ref,
) {
      ...
      return (
        <>
          ...
          <div className="grid h-full place-content-center place-items-center gap-2">
            ...
            <div className="font-bold">タスクを読み込むことができませんでした。</div>
            <button
    ...
    return (
      <>
        <div className="space-y-1">
          ...
          <RadixDialog.Title className="text-2xl font-bold">{task.title}</RadixDialog.Title>
        ...
        <div className="space-y-2">
          ...
          <div className="ml-2">
            <TaskStatusBadge done={task.done} onChangeDone={handleUpdateTaskDone} />
          </div>
        </div>
        <div className="space-y-2">
          <label className="flex items-center gap-1 text-sm text-neutral-500" htmlFor="description">
            <TextIcon size={18} />
            <div>説明</div>
          </label>
          <TaskDescriptionForm
  ...
  }, [handleUpdateTaskDesc, handleUpdateTaskDone, onOpenChange, task, taskStatus]);
      ...
      <AnimatePresence>
        {isOpen && (
          <RadixDialog.Portal forceMount>
            ...
            <RadixDialog.Content forceMount asChild aria-describedby={undefined}>
              <motion.div
                ref={ref}

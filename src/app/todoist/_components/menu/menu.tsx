...
const MenuComponent = forwardRef<HTMLButtonElement, MenuComponentProps>(function MenuComponent(
  { children, trigger, onOpenChange, placement = "bottom-start", width = 280, ...props },
  forwardedRef,
) {
                      ...
                      {...getFloatingProps({
                        onKeyDown: (e) => {
                          if (
                            ...
                            (e.target.role === "menu" || e.target.role == "menuitem")
                          ) {
                            handleOpenChange(false);
                          }
                        },
...
export const Menu = forwardRef<HTMLButtonElement, MenuProps>(function Menu(props, ref) {
  const parentId = useFloatingParentNodeId();
...
export const MenuActions: React.FC<MenuActions> = ({ label, right, children }) => {
  return (

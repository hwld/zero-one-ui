...
const MenuItemWrapper = forwardRef<HTMLButtonElement, MenuItemWrapperProps>(function MenuItem(
...
export const MenuButtonItem = forwardRef<HTMLButtonElement, ButtonItemProps>(
  function MenuButtonItem({ icon, label, description, right, variant, ...props }, ref) {
    return (
...
type SubMenuTrigger = Omit<ContentProps, "right"> & ComponentPropsWithoutRef<"button">;

export const SubMenuTrigger = forwardRef<HTMLButtonElement, SubMenuTrigger>(function SubMenuTrigger(
...
const _MenuIconButtonItem = forwardRef<HTMLButtonElement, _MenuIconButtonItemProps>(
...
export const MenuIconButtonItem: React.FC<_MenuIconButtonItemProps & { label: string }> = ({
  label,
  ...props
}) => {
  return (

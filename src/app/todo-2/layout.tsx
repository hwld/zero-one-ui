...
const Layout: React.FC<PropsWithChildren> = ({ children }) => {
  ...
  return (
    <div
      className={clsx("flex h-screen gap-6 overflow-hidden text-zinc-200", bgClass)}
      style={{ colorScheme: "dark" }}
    >
      <div className="sticky top-0 py-6 pl-6">
        <Sidebar />
      </div>
      <div ref={scrollableRootRef} className="flex w-full flex-col gap-4 overflow-auto py-6 pr-6">
...
const LayoutWithProviders: React.FC<LayoutProps<"/todo-2">> = ({ children }) => {
  return (

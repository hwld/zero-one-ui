...
const ScrollableRootContext = createContext<ScrollableRootContext | undefined>(undefined);

export const ScrollableRootProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  return <ScrollableRootContext.Provider value={value}>{children}</ScrollableRootContext.Provider>;
};
